...
import (
	...
	"github.com/oshosanya/go-dm/slave/pkg/download"
	"github.com/oshosanya/go-dm/slave/pkg/util"
)
...
var _ = Describe("Util", func() {
	...
	Describe("Test routine pool", func() {
		Context("with nothing", func() {
			It("does something stupid", func() {
				download.RunDownloadPool()
				Expect(util.GetFileNameFromURL(testURL)).To(Equal("Timaya_feat_Phyno_feat_Olamide_Telli_Person.mp3"))
			})
		})
	})
